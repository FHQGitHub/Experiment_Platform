...
GUI_XBF_DATA 	YaHei_24B_Data;
GUI_FONT     	YaHei_24B_Font;
u32		YaHei_24B_Offset = 0x0047951E;
...
static int _cbGet_24B_Data(U32 Off, U16 NumBytes, void * pVoid, void * pBuffer)
{
	SPI_FLASH_BufferRead(pBuffer, YaHei_24B_Offset + Off, NumBytes);
	return 0;
}
...
void GUI_SetXBF(void)
{
	...
	GUI_XBF_CreateFont(&YaHei_24B_Font,
	                   &YaHei_24B_Data,
	                   GUI_XBF_TYPE_PROP_AA4_EXT,
	                   _cbGet_24B_Data,
	                   (void *)0);
