...
#define PASSWD_TYPE_A           0x01
#define PASSWD_TYPE_B           0x02
...
#define RC522_RST   PEout(2)

#define SET_SPI_CS  GPIO_SetBits(GPIOB, GPIO_Pin_12)
#define CLR_SPI_CS  GPIO_ResetBits(GPIOB, GPIO_Pin_12)


extern const char new_key_A[7];
extern const char new_key_B[7]; 
extern const char default_key[6]; 
extern char card_read_buf[16];
extern char card_serial_num[16];
...
char PcdAuthState(unsigned char auth_mode,unsigned char addr,const char *pKey,unsigned char *pSnr);
char PcdWrite(unsigned char addr,const unsigned char *pData);
