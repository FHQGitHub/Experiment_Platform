	...
	if(ACTION_EXP_DETAIL == present_bar_status) {
		...
		if(2 == present_list_status) {
			if(flag_reset == routine.flags.flagAdminLogin) {
				...
				menu_list_element_set_visible(4, 2, hDevIdButton, 0);
			}
			else {
				...
				menu_list_element_set_visible(4, 2, hDevIdButton, 1);
			}
		}
		else {
...
void menu_init()
{
	...
	menu_list_element_attach(4, 2, hDevIdEdit, element_win, NULL, element_visible);
	menu_list_element_attach(4, 2, hDevIdButton, element_button, NULL, element_visible);
