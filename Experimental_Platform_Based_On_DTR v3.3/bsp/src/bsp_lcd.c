...
static void set_cursor(uint16_t _usX, uint16_t _usY)
{
	if(lcd.id == 0X9341 || lcd.id == 0X5310) {
		...
		write_command(lcd.command.set_x);
		write_ram(_usX >> 8);
		write_command(lcd.command.set_x + 1);
		write_ram(_usX & 0XFF);
		write_command(lcd.command.set_y);
		write_ram(_usY >> 8);
		write_command(lcd.command.set_y + 1);
		write_ram(_usY & 0XFF);
	} else {
...
static void set_window(uint16_t _usX0, uint16_t _usY0, uint16_t _usX1, uint16_t _usY1)
{
	if(lcd.id == 0X5510) {
		...
		write_ram(_usX0 >> 8);
		write_command(lcd.command.set_x + 1);
		write_ram(_usX0 & 0XFF);
		write_command(lcd.command.set_x + 2);
		write_ram(_usX1 >> 8);
		write_command(lcd.command.set_x + 3);
		write_ram(_usX1 & 0XFF);
		write_command(lcd.command.set_y);
		write_ram(_usY0 >> 8);
		write_command(lcd.command.set_y + 1);
		write_ram(_usY0 & 0XFF);
		write_command(lcd.command.set_y + 2);
		write_ram(_usY1 >> 8);
		write_command(lcd.command.set_y + 3);
		write_ram(_usY1 & 0XFF);
	} else if(lcd.id == 0X1963) {
